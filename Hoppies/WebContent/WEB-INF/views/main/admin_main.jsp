...
<div id ="wrap">
        <header>
            ...
            <ul class = "gnb">
                <li><a href="/front/mem/login.s"><strong>로그아웃</strong></a></li>
            </ul>
        </header>
    </div>
    ...
    <div id="mySidenav" class="sidenav">
	  ...
	  <a href="/front/admin/codeList.s">CODE</a>
	  <a href="/front/admin/boardList.s">BOARD</a>
	  <a href="/front/admin/userList.s">USER</a>
	</div>
